      ...
      <div className="terms-container">
        ...
        <div className="terms-content">
          <section className="terms-section">
            ...
            <p>
              These Terms of Service ("Terms", "Agreement") govern your relationship with the Bitcoin Calendar service 
          ...
          <section className="terms-section">
            ...
            <p>
              Bitcoin Calendar is a decentralized document creation and management platform that enables:
            </p>
            <ul>
          ...
          <section className="terms-section">
            ...
            <ul>
              ...
              <li>Bitcoin Calendar never has access to your private keys</li>
          ...
          <section className="terms-section acknowledgment">
            ...
            <p>
              By using Bitcoin Calendar, you acknowledge that you have read, understood, and agree to be 
