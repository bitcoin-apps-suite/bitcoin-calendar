    ...
    <div className={`legal-page ${!isMobile ? (devSidebarCollapsed ? 'with-sidebar-collapsed' : 'with-sidebar-expanded') : ''}`}>
      ...
      <div className="legal-container">
        <section className="legal-section">
          ...
          <p>
            Bitcoin Calendar ("we", "our", or "the Service") is committed to protecting your privacy. This Privacy Policy 
        ...
        <section className="legal-section">
          ...
          <p>
            Bitcoin Calendar is not intended for users under 13 years of age. We do not knowingly collect personal 
        ...
        <section className="legal-section">
          ...
          <ul>
            ...
            <li><strong>In-App Support:</strong> Use the support feature within Bitcoin Calendar</li>
          </ul>
          <p>
