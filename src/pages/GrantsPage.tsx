      ...
      <div className={`grants-page ${!isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${!isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        <div className="grants-container">
          ...
          <section className="grants-hero">
            ...
            <h1>Bitcoin Calendar <span style={{color: '#a855f7'}}>Grants</span></h1>
            <p className="grants-tagline">
              $BCAL token awards for quality submissions, plus public discovery platform for independent funding
            </p>
          ...
          <section className="mission-section">
            ...
            <div className="mission-content">
              <p className="mission-statement">
                Bitcoin Calendar creates <strong>a unique funding ecosystem</strong> where quality work gets recognized through 
                $BCAL token awards and becomes discoverable for potential independent funding:
              </p>
              
              <div className="mission-pillars">
                <div className="pillar">
                  <div className="pillar-icon"><DollarSign size={32} /></div>
                  <h3>Bitcoin Calendar Curation</h3>
                  <p><strong>$BCAL token awards for quality work</strong><br/>
                  We review submissions and award $BCAL tokens to exceptional proposals, signaling their quality to the broader ecosystem.</p>
                </div>
                <div className="pillar">
          ...
          <section className="focus-section">
            ...
            <div className="focus-content">
              <p className="focus-intro">
                Our platform showcases exceptional work across key innovation areas. Bitcoin Calendar awards $BCAL tokens 
              ...
              <div className="focus-areas">
                <div className="focus-area">
                  ...
                  <h4>Bitcoin Calendar Platform Development</h4>
                  <ul>
                  ...
                  <div style={{marginTop: '10px', fontSize: '12px', color: '#a855f7'}}>
                    Bitcoin Calendar awards $BCAL for platform improvements
                  </div>
                </div>
                ...
                <div className="focus-area">
                  ...
                  <div style={{marginTop: '10px', fontSize: '12px', color: '#a855f7'}}>
                    $BCAL curation signals attract funder attention
                  </div>
                </div>
              </div>
            </div>
          ...
          <section className="categories-section">
            ...
            <p className="categories-intro">
              Choose your application path below. Submit your proposal as a public .nft file, compete for $BCAL token awards, 
          ...
          <section className="cta-section">
            <div className="cta-content">
              ...
              <p>
                Apply for Bitcoin Calendar grants to support your innovative projects in blockchain publishing and development. 
          ...
          <section className="footer-note">
            <p>
              <strong>Note:</strong> Bitcoin Calendar awards grants in $BCAL tokens to support innovative projects. 
