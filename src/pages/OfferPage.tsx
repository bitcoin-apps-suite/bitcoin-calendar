...
const OfferPage: React.FC = () => {
  ...
  const isDeveloper = pathname?.includes('/developer/') || false;
  const isAuthor = pathname?.includes('/author/') || false;
      ...
      <div className={`offer-page ${!isMobile && !devSidebarCollapsed ? 'with-sidebar-expanded' : ''} ${!isMobile && devSidebarCollapsed ? 'with-sidebar-collapsed' : ''}`}>
        <div className="offer-container">
          ...
          <section className="offer-hero">
            <h1>Create Your <span style={{color: '#a855f7'}}>{isDeveloper ? 'Development' : 'Writing'} Offer</span></h1>
