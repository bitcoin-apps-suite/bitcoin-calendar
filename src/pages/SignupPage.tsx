    ...
    return (
      <div className="signup-page">
        <div className="signup-container success">
          ...
          <p>Thank you for signing up. We'll keep you updated on Bitcoin Calendar's development.</p>
          ...
          >
            Learn More About Bitcoin Calendar
          </button>
        </div>
      </div>
    );
    ...
    <div className="signup-page">
      <div className="signup-container">
        ...
        <form onSubmit={handleSubmit} className="signup-form">
          ...
          <div className="form-group">
            <label>I'm interested in Bitcoin Calendar as a:</label>
          ...
          <div className="form-footer">
            <p className="privacy-note">
              We respect your privacy. Your email will only be used for Bitcoin Calendar updates 
        ...
        <div className="signup-benefits">
          ...
          <ul>
            ...
            <li>Exclusive BCAL token opportunities</li>
        ...
        <div className="signup-stats">
          <div className="stat">
            ...
            <span className="stat-label">BCAL Tokens Reserved for Early Users</span>
          </div>
          <div className="stat">
