    ...
    <div className="App">
      ...
      <div className="token-container">
        ...
        <section className="token-hero">
          <h1><span style={{color: '#ffffff'}}>The</span> Bitcoin Calendar <span style={{color: '#ffffff'}}>Token</span></h1>
          <p className="token-tagline">
            Open-source development meets sustainable economics
          </p>
          <div className="token-badge">$BCAL</div>
        </section>
        ...
        <section className="philosophy-section">
          ...
          <div className="philosophy-content">
            <p>
              Bitcoin Calendar is an <strong>open-source project</strong> licensed under MIT and BSV licenses. 
            ...
            <p>
              The $BCAL token represents our approach to creating a sustainable economic model that 
          ...
          <div className="model-card warning">
            ...
            <ul>
              ...
              <li>
                ...
                capital raising. $BCAL tokens are rewards for contribution, not investment instruments
              </li>
              <li>
          ...
          <div className="business-content">
            ...
            <div className="value-flow">
              ...
              <div className="flow-diagram">
                ...
                <div className="flow-item">
                  <span>Dividends to $BCAL holders</span>
                  <span className="arrow">→</span>
                </div>
                <div className="flow-item">
              ...
              <p style={{textAlign: 'center', marginTop: '20px', fontSize: '14px', color: 'rgba(255, 255, 255, 0.6)'}}>
                The Bitcoin Calendar Exchange enables event organizers to tokenize, sell shares, and trade calendar events,
        ...
        <section className="stats-section">
          ...
          <div className="stats-grid">
            <div className="stat">
              ...
              <p className="stat-label">$BCAL tokens</p>
            </div>
            <div className="stat">
              <h3>Distributed</h3>
        ...
        <section className="legal-section">
          ...
          <div className="legal-content">
            <p>
              <strong>Revenue Sharing Model:</strong> The $BCAL token is designed to enable revenue 
            ...
            <p>
              <strong>Trading & Liquidity:</strong> The $BCAL token is intended to be freely tradable 
              on the Bitcoin Calendar Exchange and associated platforms. We encourage an active secondary 
