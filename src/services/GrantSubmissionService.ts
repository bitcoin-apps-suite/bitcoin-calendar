...
export class GrantSubmissionService {
  ...
  /**
   * Award $BCAL tokens to a submission (platform curation signal)
   */
    ...
    return `
      ...
      <head>
        ...
        <style>
          ...
          .header { background: linear-gradient(90deg, #a855f7, #F7931E); color: white; padding: 20px; border-radius: 8px; margin-bottom: 20px; }
          .section { margin: 20px 0; padding: 15px; border: 1px solid #eee; border-radius: 5px; }
          .label { font-weight: bold; color: #333; }
          .value { margin-left: 10px; }
          .amount { font-size: 1.2em; color: #a855f7; font-weight: bold; }
        </style>
      </head>
      <body>
        <div class="header">
        ...
        <div class="section">
          ...
          <p><span class="label">Platform:</span><span class="value">Bitcoin Calendar</span></p>
  ...
  private calculateQualityScore(awardAmount: number): number {
    // Simple quality scoring based on $BCAL award
