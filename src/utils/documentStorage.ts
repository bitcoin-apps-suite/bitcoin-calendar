  ...
  static initializeDefaultDocuments(): void {
    ...
    if (!stored || stored === '[]') {
      const maipDoc: LocalDocument = {
        ...
        content: `<h1 style="color: #a855f7; font-size: 48px; text-align: center; margin-bottom: 10px;">Multi-Authoring in Public (MAIP)</h1>
...
<h2 style="color: #a855f7; border-bottom: 2px solid rgba(255, 107, 53, 0.3); padding-bottom: 10px;">📝 Executive Summary</h2>
...
<h2 style="color: #a855f7; border-bottom: 2px solid rgba(255, 107, 53, 0.3); padding-bottom: 10px; margin-top: 40px;">🎯 The Vision</h2>
...
<li style="padding: 12px; margin-bottom: 10px; background: rgba(255, 107, 53, 0.05); border-left: 4px solid #a855f7; border-radius: 4px;"><strong style="color: #a855f7;">⚡ Real-Time Collaboration:</strong> Multiple authors working simultaneously with blockchain-verified contributions</li>
<li style="padding: 12px; margin-bottom: 10px; background: rgba(255, 107, 53, 0.05); border-left: 4px solid #a855f7; border-radius: 4px;"><strong style="color: #a855f7;">💰 Micro-Payments:</strong> Every edit, suggestion, and improvement triggers automatic BSV micropayments</li>
<li style="padding: 12px; margin-bottom: 10px; background: rgba(255, 107, 53, 0.05); border-left: 4px solid #a855f7; border-radius: 4px;"><strong style="color: #a855f7;">📊 Contribution Tracking:</strong> Immutable record of who wrote what, when, and how much value they added</li>
<li style="padding: 12px; margin-bottom: 10px; background: rgba(255, 107, 53, 0.05); border-left: 4px solid #a855f7; border-radius: 4px;"><strong style="color: #a855f7;">🌍 Public by Default:</strong> All writing happens in public view, creating unprecedented transparency</li>
</ul>

<h2 style="color: #a855f7; border-bottom: 2px solid rgba(255, 107, 53, 0.3); padding-bottom: 10px; margin-top: 40px;">⚙️ How MAIP Works</h2>
