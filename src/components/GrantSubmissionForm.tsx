...
const GrantSubmissionForm: React.FC<GrantSubmissionFormProps> = ({ 
  ...
  const getFieldPlaceholder = (field: string) => {
    const placeholders: { [key: string]: { [key: string]: string } } = {
      developer: {
        projectTitle: 'Bitcoin Calendar Plugin Development',
      ...
      <div className="submission-success">
        ...
        <div className="nft-info">
          ...
          <ul>
            ...
            <li>Bitcoin Calendar will review and potentially award $BCAL tokens</li>
        ...
        <div className="form-section">
          ...
          <div className="form-row">
            ...
            <div className="form-group">
              ...
              >
                <option value="BCAL">$BCAL Tokens</option>
